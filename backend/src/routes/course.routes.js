...
import {
  ...
  myCourseslist, instructorStats, instructorStudents, getManageCourse, createCourse, updateCourse, publishCourse, archiveCourse,
...
router.get('/instructor/students', authenticate, authorize('instructor', 'admin'), instructorStudents)
router.get('/manage/:id', authenticate, authorize('instructor', 'admin'), getManageCourse)
