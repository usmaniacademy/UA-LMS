<template>
  <section class="position-relative">
    <div class="position-absolute bottom-0 end-0">
      <img :src="element30" class="h-300px" alt="">
    </div>
    ...
    <b-container>
      <b-row class="g-4">
        <b-col sm="6" lg="4">
          ...
          <p class="mb-0">Comfort reached gay perhaps chamber his six detract besides add. Moonlight newspaper up its
            enjoyment agreeable depending.</p>
        </b-col>

        <b-col sm="6" lg="4">
          <b-card no-body class="card-body bg-light p-4 h-100">
            <figure>
            ...
            <p class="mb-0">Mountains in just switching city steps Might rung line what Was or between towards the
              have phase.</p>
          </b-card>
        </b-col>
        ...
        <b-col sm="6" lg="4">
          <b-card no-body class="card-body bg-light p-4 h-100">
            ...
            <p class="mb-0">Prisoners And mountains in just switching city steps Might rung line Was or between the
              have phase.</p>
          </b-card>
        </b-col>
        ...
        <b-col sm="6" lg="4">
          <b-card no-body class="card-body bg-light p-4 h-100">
            ...
            <p class="mb-0">Switching city steps Might rung line what Mr Bulk; Was or between towards the have phase.
            </p>
          </b-card>
        </b-col>
