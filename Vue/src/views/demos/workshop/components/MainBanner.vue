<template>
  <section class="overflow-hidden pt-6 pt-xxl-0">
    <b-container fluid>
      <b-row class="g-4 g-md-5 align-items-center justify-content-between	mb-xxl-n7">
        <b-col lg="3" xl="4" xxl="3" class="d-none d-lg-block">
          <b-row class="g-md-5 align-items-center ms-n6">
            <b-col cols="6">
              <img :src="bg07" class="rounded-3 mt-6 mb-5" alt="">
              <img :src="bg06" class="rounded-3" alt="">
            </b-col>

            <b-col cols="6" class="position-relative">
              <img :src="bg05" class="rounded-3" alt="">
              <img :src="element17" class="h-60px position-absolute top-0 start-0 ms-3 mt-n3" alt="" />
            </b-col>
          </b-row>
        </b-col>
        ...
        <b-col lg="3" xl="4" xxl="3">
          <b-row class="g-4 align-items-center me-n4">
            <b-col cols="4">
              <img :src="bg01" class="rounded-3" alt="">
            </b-col>
            ...
            <b-col cols="3">
              <img :src="bg04" class="rounded-3 mt-7 mb-5" alt="">
              <img :src="bg08" class="rounded-3 mb-n8" alt="">
            </b-col>
          </b-row>
        </b-col>
      </b-row>
