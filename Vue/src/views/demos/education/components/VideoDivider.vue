<template>
	<section class="bg-light position-relative">
		...
		<b-container class="position-relative">
			<b-row class="justify-content-between align-items-center my-5">
				<b-col lg="5" class="position-relative">
				...
				<b-col lg="5" class="position-relative mt-4 mt-lg-0">
					<img :src="about04" class="border border-5 border-white rounded-2" alt="">
					<div class="position-absolute top-50 start-50 translate-middle">
						<CustomGLightbox link="https://www.youtube.com/embed/tXHviS-4ygo"
							class="btn text-danger btn-round btn-white-shadow btn-lg mb-0">
