  ...
  <section class="position-relative pt-5">
    ...
    <b-container>
      <b-row class="align-items-center justify-content-between">
        <b-col lg="6" class="position-relative z-index-9">
          <h6 class="mb-3 font-base d-flex justify-content-start">
            <BIconPinMapFill class="me-2" />
            St Joseph, Eugene, Oregon, USA
          </h6>
          <h1 class="display-4">Academia tuition classes</h1>
          <p class="lead mb-4">We are so eager to be working with kids and making a difference in their careers. Being
            a mentor is what we have always wanted to be.</p>

          <b-row class="my-3">
            <div class="arrow-round arrow-dark arrow-hover arrow-xs">
              <CustomTinySlider :settings="settings" id="tutor-slider">
                <div v-for="(item, idx) in testimonialList" :key="idx">
                  <div class="d-md-flex my-2">
                    ...
                    <div class="flex-grow-1 mt-2 mt-md-0">
                      <p class="mb-2">{{ item.testimonial }}</p>
                      <h6 class="me-3 mb-0">{{ item.name }}<span class="small mb-0 text-body">(Student)</span></h6>
                    </div>
                  </div>
                </div>
              </CustomTinySlider>
          ...
          <a href="#contact-form" class="btn btn-primary">Contact me!</a>
        </b-col>

        <b-col lg="6" class="position-relative mt-5 mt-lg-0">
          ...
          <figure class="position-absolute bottom-0 end-0 mb-n5 z-index-9">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="129px"
              height="133px">
            ...
            <div class="px-4 py-3 bg-white bg-opacity-10 bg-blur border border-light shadow-lg rounded-4">
              ...
              <ul class="list-inline mb-0 hstack gap-1">
                <li class="list-inline-item" v-for="(link, idx) in socialLink" :key="idx">
                  <a :class="`btn btn-round btn-sm ${link.class}`" href="#">
          ...
          <div class="position-absolute bottom-0 start-0 mb-0 mb-sm-4 ms-3 ms-sm-5 z-index-9">
            <div class="d-flex align-items-center p-2 p-sm-3 bg-white shadow rounded-4">
              <div class="icon-lg bg-white rounded-circle shadow">
                <img :src="element17" class="h-30px" alt="">
              </div>
              <div class="ms-2">
                <h6 class="mb-0 text-dark">Best tutor Award</h6>
                <span class="small">Year 2021</span>
              </div>
            </div>
          </div>

          <img :src="about07" class="rounded-3 z-index-1 position-relative" alt="tutor img">
        </b-col>
      </b-row>
    </b-container>
  </section>
...
import { testimonialList } from '@/views/demos/tutor/components/data';
