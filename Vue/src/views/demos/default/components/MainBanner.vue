    ...
    <b-container>
      <b-row class="align-items-center g-5">
        <b-col lg="5" xl="6" class="position-relative z-index-1 text-center text-lg-start mb-7 mb-sm-0">
          ...
          <p class="my-4 lead">Online learning and teaching marketplace with 5K+ courses & 10M students. Taught by
            experts to help you acquire new skills.</p>

          <ul class="list-inline position-relative justify-content-center justify-content-lg-start mb-4">
            <li class="list-inline-item me-2">
              <BIconPatchCheckFill class="h6 me-1 mt-1" />Learn with experts
            </li>{{ ' ' }}
            <li class="list-inline-item me-2">
              <BIconPatchCheckFill class="h6 me-1 mt-1" />Get certificate
            </li>{{ ' ' }}
            <li class="list-inline-item">
              <BIconPatchCheckFill class="h6 me-1 mt-1" />Get membership
            </li>
          </ul>
