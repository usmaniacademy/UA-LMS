      ...
      <b-row>
        <b-col cols="12">
          <div class="bg-light p-4 p-sm-5 rounded-3 position-relative overflow-hidden">
            ...
            <img :src="element09" class="position-absolute bottom-0 end-0 z-index-1 d-none d-lg-block me-n3" alt="">
            ...
            <b-row class="g-4 justify-content-center align-items-center position-relative">
              <b-col lg="3" class="text-center text-lg-start ps-0">
                <img :src="element08" alt="">
              </b-col>
              ...
              <b-col lg="3" class="text-center text-lg-end z-index-9">
