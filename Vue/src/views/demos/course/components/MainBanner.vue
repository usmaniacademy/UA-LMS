<template>
  <section class="bg-light">
    <b-container class="pt-5 mt-0 mt-lg-5">
      <b-row class="position-relative mb-0 mb-sm-5 pb-0 pb-lg-5">
        <b-col lg="8" class="text-center mx-auto position-relative">
          ...
          <p>Get inspired and discover something new today. Grow your skill with the most reliable online courses and
            certifications in marketing, information technology, programming, and data science. </p>
          <b-col md="8" class="text-center mx-auto pb-5">
            <b-form class="bg-body shadow rounded p-2">
              <b-input-group>
                <b-form-input class="border-0 me-1" type="search" placeholder="Find your course" />
