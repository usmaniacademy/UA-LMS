<template>
  <section class="pt-0 pt-lg-5">
    <b-container>
      ...
      <b-row class="g-4">
        <b-col md="6" xl="4" v-for="(item, idx) in courseList" :key="idx">
          <TrendingCourseCard :item="item" />
        </b-col>
      </b-row>
    </b-container>
  </section>
...
import { courseList } from '@/views/demos/academy/components/data';
import TrendingCourseCard from '@/views/demos/academy/components/TrendingCourseCard.vue';
</script>