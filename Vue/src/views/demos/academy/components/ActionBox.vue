      ...
      <b-row>
        <b-col cols="12" class="position-relative z-index-1">
          ...
          <div class="bg-grad-pink p-4 p-sm-5 rounded position-relative z-index-n1 overflow-hidden">
            ...
            <b-row class="g-3 align-items-center justify-content-lg-end position-relative py-4">
              <b-col md="6">
              ...
              <b-col md="6" lg="3" class="text-md-end">
...
import element01 from '@/assets/images/element/01.png';
import clientpencil from '@/assets/images/client/pencil.svg';
import clientgraduated from '@/assets/images/client/graduated.svg';
</script>