      ...
      <b-row>
        <b-col cols="12">
          <div class="arrow-round arrow-blur arrow-hover rounded-3 overflow-hidden">
            <CustomTinySlider :settings="settings" id="uni-slider">
              <b-card no-body class="overflow-hidden h-500px h-md-600px text-center rounded-0"
                :style="`background-image:url(${bg01}); background-position: center left; background-size: cover;`">
                  ...
                  <div class="w-100 my-auto">
                    <b-row class="justify-content-center">
                      <b-col cols="11" lg="7">
                        ...
                        <p class="text-white">This Bootstrap 5 based theme is ideal for all types of sites that offer
                          education such as Kindergarten, School, College, University, Courses Hub, Training Center,
                          or any Academy.</p>
                        <router-link :to="{name: 'form.admission.form'}" class="btn btn-primary me-2 mb-0">Admissions</router-link>
              ...
              <b-card no-body class="overflow-hidden h-500px h-md-600px text-center rounded-0"
                :style="`background-image:url(${bg02}); background-position: center left; background-size: cover;`">
                <div class="bg-overlay bg-dark opacity-6"></div>
                <div class="card-img-overlay d-flex align-items-center p-3 p-sm-4">
                  <div class="w-100 my-auto">
                    <b-row class="justify-content-center">
                      <b-col cols="11" lg="6">
                        <img class="rounded-1 h-70px" :src="unilogo01" alt="university logo">
                        <h1 class="mb-0 text-white display-6">Get new skills <br> for the
                          <span class="position-relative">digital world
                            <span class="position-absolute top-50 start-50 translate-middle ms-4 z-index-n1">
                              <svg width="366px" height="62.1px" enable-background="new 0 0 366 62.1"
                        ...
                        <p class="text-white">Get the right professional certificate program for you. See what course
                          other students and experts in your domain are learning on</p>
