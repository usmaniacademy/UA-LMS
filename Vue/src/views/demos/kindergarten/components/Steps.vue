<template>
  <section class="position-relative pt-0 pt-lg-5">
    ...
    <b-container>
      ...
      <b-row class="g-lg-5 mt-3">
        <b-col md="6" lg="4" class="text-center position-relative">
        ...
        <b-col md="6" lg="4" class="text-center pt-0 pt-lg-5 position-relative">
          ...
          <div class="px-4">
            ...
            <p class="text-truncate-2 pb-0">Who diminution astonished. Yet uncommonly his ten who diminution astonished.
            </p>
          </div>
        </b-col>
...
import idea from '@/assets/images/element/idea.svg';
