<template>
  <section class="position-relative overflow-hidden pt-4 py-sm-5">
    <div class="position-absolute bottom-0 start-0 rotate-74 d-none d-md-block">
      <img :src="elementrocket" alt="">
    </div>
    <b-container>
      <b-row>
        <b-col xl="3" class="mt-0 pt-0 mt-xl-5 pt-xl-5 text-center position-relative d-none d-xl-block">
        ...
        <b-col xl="6" class="text-center">
          <h6 class="mb-3 font-base bg-blue text-white py-2 px-4 rounded-2 d-inline-block">
            <font-awesome-icon :icon="faSchool" class="me-1" />
            St Joseph, Eugene, Oregon, USA
          </h6>
          <h1>The Best kindergarten You Can Get</h1>
          <p class="mb-5">The best cost-efficient choice for parents looking for high-quality education, Dedicated
            Timetabled Lessons Offered with qualified Staff.</p>

          <b-row class="g-4 justify-content-center">
            <b-col sm="6" md="4" xl="6" xxl="4">
              <div class="d-flex justify-content-center align-items-center">
                <div class="icon-lg bg-body shadow rounded-circle text-info mb-0">
                  <font-awesome-icon :icon="faUserGraduate" class="fa-fw" />
                </div>
                <div class="ms-3">
                  <div class="d-flex text-dark">
                    <NumberAnimation :from="0" :to="1" :duration="3" :format="format" :delay="0.5"
            ...
            <b-col sm="6" md="4" xl="6" xxl="4">
              <div class="d-flex justify-content-center align-items-center">
                <div class="icon-lg bg-body shadow rounded-circle text-purple mb-0">
                  <font-awesome-icon :icon="faChalkboardTeacher" class="fa-fw" />
                </div>
                <div class="ms-3 text-start">
                  <NumberAnimation :from="0" :to="105" :duration="3" :format="format" :delay="0.5"
                    class="purecounter mb-0 fw-bold h5" />
                  <br />
            ...
            <b-col sm="6" md="4" xl="6" xxl="4">
              <div class="d-flex justify-content-center align-items-center">
                <div class="icon-lg bg-body shadow rounded-circle text-danger mb-0">
                  <font-awesome-icon :icon="faBookReader" class="fa-fw" />
                </div>
                <div class="ms-3">
                  <div class="d-flex text-dark">
                    <NumberAnimation :from="0" :to="2" :duration="3" :format="format" :delay="0.5"
                      class="purecounter mb-0 fw-bold h5" />
                    <span class="mb-0 h5">K+</span>
                  </div>
        ...
        <b-col xl="3" class="position-relative text-center">
          ...
          <div class="position-relative ms-5 mt-5">
            ...
            <img :src="element04" class="me-5 mb-4 position-relative" alt="">
          </div>
        </b-col>
      </b-row>
    </b-container>
...
import { faSchool, faUserGraduate, faChalkboardTeacher, faBookReader, faStar, faStarHalfAlt } from '@fortawesome/free-solid-svg-icons';

import elementrocket from '@/assets/images/element/rocket.svg';
import element05 from '@/assets/images/element/05.png';
import element04 from '@/assets/images/element/04.png';
