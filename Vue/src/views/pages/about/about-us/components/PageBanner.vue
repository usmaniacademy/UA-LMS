<template>
  <section>
    <b-container>
      <b-row class="g-4">
        <b-col cols="10" class="text-center mx-auto position-relative">
      ...
      <b-row class="g-4 mt-0 mt-lg-5">
        <b-col cols="6" md="4">
          <b-row class="g-4">
            <b-col cols="10" lg="6">
              <img class="rounded-4" :src="about05" alt="">
            </b-col>
            <b-col cols="12">
              <img class="rounded-4" :src="about03" alt="">
            </b-col>
          </b-row>
        </b-col>
        <b-col cols="6" md="4" class="position-relative">
          ...
          <img class="rounded-4" :src="about09" alt="">
        </b-col>
        <b-col md="4">
          <b-row class="g-4">
            <b-col sm="6" md="12">
              <div class="bg-grad rounded-4 p-5 text-start">
                ...
                <h3 class="text-white">“Be open to new ideas and approaches. Develop your problem-solving skills.”
                </h3>
              </div>
            </b-col>
            <b-col sm="6" md="12" lg="6">
              <img class="rounded-4" :src="about10" alt="">
            </b-col>
          </b-row>
        </b-col>
      </b-row>
