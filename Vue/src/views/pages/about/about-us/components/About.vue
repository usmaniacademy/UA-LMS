    ...
    <b-container>
      <b-row class="mb-4">
        <b-col lg="8">
          ...
          <p class="mb-0">How promotion excellent curiosity yet attempted happiness Gay prosperous impression had
      ...
      <b-row class="align-items-center">
        <b-col lg="5" class="position-relative">
          ...
          <img :src="about06" class="rounded" alt="">
        </b-col>

        <b-col lg="7" class="mt-4 mt-lg-0">
          ...
          <p>How promotion excellent curiosity yet attempted happiness Gay prosperous impression had conviction For
            every delay death ask to style Me mean able my by in they Extremity now strangers contained breakfast
            him discourse additions Sincerity collected contented led now perpetual extremely forfeited </p>
          ...
          <ul class="list-group list-group-borderless mt-4">
            <li class="list-group-item d-flex">
              <BIconPatchCheckFill class="text-success me-2" />Setup and installation takes less time
            </li>
            <li class="list-group-item d-flex">
              <BIconPatchCheckFill class="text-success me-2" />Professional and easy to use software
            </li>
            <li class="list-group-item d-flex">
              <BIconPatchCheckFill class="text-success me-2" />Perfect for any device with pixel-perfect design
            </li>
            <li class="list-group-item d-flex">
              <BIconPatchCheckFill class="text-success me-2" />Setup and installation too fast
            </li>
          </ul>

          <b-row class="mt-3 g-4">
            <b-col md="6" v-for="(item, idx) in aboutData" :key="idx">
              <div class="overflow-hidden">
                <h6>{{ item.title }}</h6>
                <b-progress class="progress-sm bg-primary bg-opacity-10">
                  <b-progress-bar class="aos" :value="item.progress">
                    <span class="progress-percent-simple ms-auto h6 fw-light">{{ item.progress }}%</span>
                  </b-progress-bar>
                </b-progress>
              </div>
            </b-col>
...
import { aboutData } from '@/views/pages/about/about-us/components/data';
