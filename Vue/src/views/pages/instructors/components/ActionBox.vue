					...
					<b-col cols="11" class="position-relative">
						<b-row class="align-items-center">
							<b-col lg="7">
								...
								<p class="text-white mb-3 mb-lg-0">Speedily say has suitable disposal add boy. On forth doubt miles of
									child. Exercise joy man children rejoiced. Yet uncommonly his ten who diminution astonished.</p>
							</b-col>
