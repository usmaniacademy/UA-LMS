      ...
      <b-row class="g-4 align-items-center">
        <b-col md="6" class="position-relative">
          ...
          <h1 class="mb-4 display-6 ">Let's Learn New Courses & Gain
            <span class="position-relative z-index-9">More Skills
              <span class="position-absolute top-50 start-50 translate-middle z-index-1 mt-n2 d-none d-sm-block">
                <svg class="fill-warning" width="357px" height="84.1px" viewBox="0 0 357 84.1"
                  style="enable-background:new 0 0 357 84.1;" xml:space="preserve">
                  <path
          ...
          <div class="d-lg-flex mb-4">
            <a href="#" class="btn btn-primary me-4">View Courses<BIconArrowRight class="ms-2" /></a>
            <a href="#" class="btn btn-light">
              <font-awesome-icon :icon="faPhotoVideo" class="me-2" />
              See it in action
...
import element08 from '@/assets/images/element/08.png'

import { faPhotoVideo } from '@fortawesome/free-solid-svg-icons';
import { BIconLightbulb, BIconArrowRight, BIconInfoCircle, BIconPower } from 'bootstrap-icons-vue';
</script>