<template>
  ...
  <main>
    <section class="pt-4 pt-sm-5">
      <b-container>
        <b-row class="g-4 g-md-5 justify-content-between">
          <b-col lg="6" class="mb-5 mb-lg-0">
            <h1>Request a Demo</h1>
            <p class="mb-5">Let's find out the demo. The 1-hour demo will provide Happiness prosperous impression had
              conviction For every delay in their Extremity now, strangers</p>
            ...
            <ul class="list-group list-group-borderless mt-3 mb-sm-5">
              <li class="list-group-item h6 fw-light d-flex">
                <font-awesome-icon :icon="faCheckCircle" class="fa-fw text-success me-2" />
            ...
            <b-row class="justify-content-center">
              ...
              <b-col md="12">
                <CustomTinySlider :settings="settings" id="form-demo-slider" class="arrow-round">
                  <div class="item" v-for="(img, idx) in client" :key="idx">
                    <img class="grayscale" :src="img" alt="">
                  </div>
                </CustomTinySlider>
              </b-col>
            </b-row>
          ...
          <b-col lg="6" class="mb-5">
            <div class="bg-dark rounded-3 p-4 p-sm-5 position-relative">
              ...
              <figure class="position-absolute top-0 start-50 translate-middle w-100 mt-n1">
                <svg enable-background="new 0 0 420.7 53.6" version="1.1" viewBox="0 0 420.7 53.6" xml:space="preserve"
              ...
              <figure class="w-100 position-absolute top-100 start-50 translate-middle">
                <svg enable-background="new 0 0 607.7 74.6" version="1.1" viewBox="0 0 607.7 74.6" xml:space="preserve"
                  xmlns="http://www.w3.org/2000/svg">
                  <path class="fill-dark"
              ...
              <b-form class="row g-3 position-relative">
                <b-col md="6" class="bg-dark-input">
                  <b-form-group label-class="text-white text-opacity-50">
                    <template #label>
                ...
                <b-col md="6" class="bg-dark-input">
                  <b-form-group label-class="text-white text-opacity-50">
                    ...
                    <b-form-input type="text" id="companySize" />
                  </b-form-group>
                </b-col>

                <b-col cols="12" class="bg-dark-input">
                  <b-form-group label="Additional note(s)" label-class="text-white text-opacity-50">
                ...
                <b-col cols="12" class="bg-dark-input">
                  <div class="d-grid">
                    <b-button variant="primary" size="lg">Request a demo</b-button>
                  </div>
                  <p class="mb-0 text-white text-opacity-50 small">Field required with <span
                      class="text-danger fw-bold">*</span> are
                    required to complete the demo request</p>
                </b-col>
              </b-form>
            </div>
          </b-col>
...
const client = [cocacola, android, envato, microsoft, netflix, google, linkedin];
