<template>
  ...
  <main>
    <section class="position-relative pt-4 pt-sm-5">
      ...
      <b-container class="position-relative z-index-9">
        <b-row class="g-4 g-sm-5 justify-content-between">
            ...
            <b-row class="mt-4">
                ...
                <div class="d-flex align-items-center">
                  <div>
                    <div class="icon-xl bg-body shadow rounded-circle">
                      <img :src="child" class="h-40px" alt="">
                    </div>
                  </div>
                  <div class="ms-3">
                    <h5 class="mb-0">We care about students</h5>
                    <p class="text-truncate-2 mb-0">Man children rejoiced yet uncommonly his ten who. Yet uncommonly
              ...
              <b-col cols="12" class="mb-5">
                <div class="d-flex align-items-center">
                  <div>
                    <div class="icon-xl bg-body shadow rounded-circle">
                      <img :src="help" class="h-40px" alt="">
                    </div>
                  </div>
                  <div class="ms-3">
                    <h5 class="mb-0">Helping struggling students</h5>
                    <p class="text-truncate-2 mb-0">Children rejoiced yet uncommonly his ten who. Yet uncommonly his
                      ten who diminution astonished.</p>
                  </div>
                </div>
              </b-col>
            </b-row>
            ...
            <div class="d-sm-flex justify-content-sm-between align-items-center">
              ...
              <div>
                ...
                <ul class="list-inline mb-1 hstack gap-1">
                  ...
                  <li class="list-inline-item me-0 mb-0"><font-awesome-icon :icon="faStar" class="text-warning" /></li>
                  <li class="list-inline-item me-0 mb-0"><font-awesome-icon :icon="faStar" class="text-warning" /></li>
                  <li class="list-inline-item me-0 mb-0"><font-awesome-icon :icon="faStarHalfAlt"
          ...
          <b-col lg="6" class="position-relative">
            ...
            <div class="bg-primary bg-opacity-10 rounded-3 p-4 p-sm-5">
              ...
              <b-form class="row g-4 g-sm-3 mt-2 mb-0">
                <b-col cols="12">
                ...
                <b-col cols="12">
                  <b-form-group label="Select class *">
                    <b-form-select v-model="classSelected" :options="classOptions" />
                  </b-form-group>
                </b-col>
                <b-col cols="12" class="d-grid">
                  <b-button type="submit" variant="primary" size="lg" class="mb-0">Book a class</b-button>
                </b-col>
              </b-form>
            </div>
          </b-col>
