  ...
  <b-card no-body class="shadow">
    ...
    <b-card-body class="pb-0">
      <div class="d-flex justify-content-between mb-2">
        <a href="#" :class="`badge bg-${item.badgeColor} bg-opacity-10 text-${item.badgeColor}`">{{ item.badge }}</a>
...
import { faStar, faStarHalfAlt, faHeart, faTable } from '@fortawesome/free-solid-svg-icons';
import { faClock, faStar as faStarR } from '@fortawesome/free-regular-svg-icons';
