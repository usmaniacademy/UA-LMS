    ...
    <b-container class="position-relative overflow-hidden">
      ...
      <div class="bg-grad-pink p-3 p-sm-5 rounded-3">
        <b-row class="justify-content-center position-relative">
          ...
          <b-col cols="12" class="position-relative my-2 my-sm-3">
            <b-row class="align-items-center">
              <b-col lg="6">
                <h3 class="text-white mb-3 mb-lg-0">Are you ready for a more great Conversation?</h3>
              </b-col>
              <b-col lg="6" class="text-lg-end">
                <b-form class="bg-body rounded p-2">
                  <b-input-group>
                    <b-form-input class="border-0 me-1" type="email" placeholder="Type your email here" />
                    <b-button type="button" variant="dark" class="mb-0 rounded">Subscribe</b-button>
                  </b-input-group>
                </b-form>
              </b-col>
            </b-row>
