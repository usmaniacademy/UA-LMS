      ...
      <b-card-body class="pb-0">
        <div class="table-responsive border-0 mb-0">
          <table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
            ...
            <tbody>
              <tr v-for="(item, idx) in studentReviewList" :key="idx">
                <td>
                ...
                <td>
                  <a href="#" class="btn btn-sm btn-info-soft mb-0 me-1" data-bs-toggle="modal" data-bs-target="#viewReview"
...
import { ref } from 'vue';
import { studentReviewList } from '@/views/admin/courses/details/components/data';
