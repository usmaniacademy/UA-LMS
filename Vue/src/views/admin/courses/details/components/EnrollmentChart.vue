    ...
    <b-card no-body class="bg-transparent border overflow-hidden">
      ...
      <b-card-body class="p-0">
        <div class="d-sm-flex justify-content-between p-4">
          ...
          <p class="mb-0"><span class="text-success me-1">0.35%<BIconArrowUp /></span>vs last
            Week</p>
        </div>
        <ApexChart :chart="newEnrollmentChart" class="apex-charts" id="activeChartstudent2" />
      </b-card-body>
    </b-card>
  </b-col>
</template>
<script setup lang="ts">
import { newEnrollmentChart } from '@/views/admin/courses/details/components/data';
