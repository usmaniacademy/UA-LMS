      ...
      <b-card-body class="pb-0">
        <div class="table-responsive border-0 mb-0">
          <table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
            ...
            <tbody>
              <tr v-for="(item, idx) in reviewList">
                <td>
...
import { reviewList } from '@/views/admin/instructors/details/components/data';
import { faStar, faAngleLeft, faAngleRight, faStarHalfAlt } from '@fortawesome/free-solid-svg-icons';
